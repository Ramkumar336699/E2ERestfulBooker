package org.E2ERestfulBooker.tests.crud;
...
public class CRUDTypes {
    ...
    public void testCreateBooking() throws JsonProcessingException {
        ...
        requestSpecification.basePath(org.E2ERestfulBooker.endPoints.APIConstants.CREATE_BOOKING);
    ...
    public void testCreateToken() {
        ...
        requestSpecification.basePath(org.E2ERestfulBooker.endPoints.APIConstants.CREATE_TOKEN);
        payloadManager = new PayloadManager();
        ValidatableResponse response = RestAssured.given().spec(requestSpecification)
...
//        testCreateBooking();
        payloadManager = new PayloadManager();
        requestSpecification.basePath(org.E2ERestfulBooker.endPoints.APIConstants.UPDATE_BOOKING+bookingId);
